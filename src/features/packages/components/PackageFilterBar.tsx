...
import type { PackageFilterStatus } from '../types/package.types';
...
export const PackageFilterBar: React.FC<PackageFilterBarProps> = ({
  ...
  return (
    <div className="p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-slate-100" dir="rtl">
      {/* Right Action: Add Package Button */}
      <button
        type="button"
        onClick={onAddPackageClick}
        className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-[#d83f2a] hover:bg-[#c23420] text-white font-extrabold text-xs shadow-md shadow-[#d83f2a]/20 transition flex items-center justify-center gap-2 cursor-pointer"
      >
      ...
      {/* Left Actions: Search + Status Filter */}
